...
class Player:
    def __init__(self, game):
        ...
        self.left_hand = hands.Hands(c.left_hand_path, c.left_hand_pos, 'left')
        self.right_hand = hands.Hands(c.right_hand_path, c.right_hand_pos,'right')
